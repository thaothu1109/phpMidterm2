...
nav ul li a:hover {
    ...
    color: #0c046d;
    border-radius: 30px;
    border: 0.1px solid #0097b2; /* Thêm đường viền màu xanh */
}
        ...
        .search-button {
            ...
            text-decoration: none;
            font-size: 14px;
            background-color: #0097b2;  /* Màu nền nút */
            color: white; /* Màu chữ */
            cursor: pointer; /* Con trỏ chuột khi hover */
        }
        .search-button:hover {
            background-color: #64d2e6; /* Màu nền khi hover */
        }
        .fa-circle-plus {
            margin-top: -25px;
            margin-left: 300px; 
            ...
            border: none; /* Không có đường viền */
            border-radius: 20px; /* Bo góc nút */
            background-color: #0097b2; /* Màu nền nút thêm */
            color: white; /* Màu chữ */
            cursor: pointer; /* Con trỏ chuột khi hover */
            position: absolute;  
        }
...
.trang a {
    ...
    color: #0097b2; /* Màu chữ */
    background-color: #f8f9fa; /* Màu nền */
    border: 1px solid #0097b2; /* Viền */
    border-radius: 20px; /* Bo góc */
    transition: background-color 0.3s, color 0.3s; /* Hiệu ứng chuyển màu */
}

.trang a:hover {
    background-color: #0097b2; /* Màu nền khi hover */
...
.trang span {
    ...
    padding: 10px 15px; /* Khoảng cách bên trong */
    margin: 0 5px; /* Khoảng cách giữa các liên kết */
    background-color: #0097b2; /* Màu nền cho trang hiện tại */
...
<body>
    ...
    <nav class="loaisp">
    <img src="Screenshot 2024-10-30 040256.png" alt="Khoá học" style="width: 100px; height: 60px; "> 
